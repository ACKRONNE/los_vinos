...
class ProduccionAnualVino(db.Model):
    ...
    clasificacion_añada = Column(String(5), nullable=False)
    ...
    __table_args__ = (
        ...
        CheckConstraint(clasificacion_añada.in_(['E', 'MB']), name='check_clasi_añada'),
    )

    def __init__(self, id_pais_pro, id_region, id_bodega, id_vino, ano_produccion, botellas_producidas, total_dest_exp_hl, clasificacion_añada):
        ...
        self.clasificacion_añada = clasificacion_añada
